...
# -----------------------
# Logging/Notify helpers (Logging Path Fix is Applied Here)
# -----------------------
...
# -----------------------
# Dynamic Whitelist (Updated with your DC and system processes)
# -----------------------
function Get-Whitelist {
    ...
    # ADDED: Explicitly whitelist critical server process executables
